...
Python-разработчик с опытом автоматизации бизнес-процессов и системным инженерным мышлением. 17 лет работы в промышленности и управления собственным бизнесом научили меня решать сложные задачи и видеть продукт целиком. Сейчас я сфокусирован на backend-разработке и ищу удаленную работу в команде, где смогу применить навыки Python/Django.
...
**Веб-технологии (базовый уровень):**
...
*   **Профиль на DVMN:** [ссылка на ваш профиль](https://dvmn.org/user/gribojor/)
*   **Резюме на hh.ru:** [ссылка на резюме](https://nadym.hh.ru/resume/d6cf6993ff107329aa0039ed1f4536786b6256?print=true)
